...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MotherRecord>(
      stream: MotherRecord.getDocument(widget.motherDets!),
      builder: (context, snapshot) {
        ...
        final editProfileMotherRecord = snapshot.data!;
                      ...
                      children: [
                        ...
                        TextFormField(
                          controller: _model.textController1 ??=
                            ...
                            text: editProfileMotherRecord.name,
                          ),
                        ...
                        TextFormField(
                          controller: _model.textController2 ??=
                              TextEditingController(
                            text: editProfileMotherRecord.phoneNumber,
                          ),
                        ...
                        TextFormField(
                          controller: _model.textController3 ??=
                              TextEditingController(
                            text: editProfileMotherRecord.occupation,
                          ),
                        ...
                        TextFormField(
                          controller: _model.textController4 ??=
                              TextEditingController(
                            text: editProfileMotherRecord.address,
                          ),
