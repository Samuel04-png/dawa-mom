...
// Supabase-backed compatibility helpers for FlutterFlow-generated schema code.
// These names are legacy FlutterFlow/Firestore API names; the active
// DocumentReference, Query, Timestamp, and FieldValue implementations come from
...
DocumentReference toRef(String ref) => SupabaseDatabase.instance.doc(ref);
