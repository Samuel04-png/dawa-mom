                          ...
                          Padding(
                            ...
                            child: Text(
                              'Select Date: ${valueOrDefault<String>(
                                dateTimeFormat(
                                    "EEEE", _model.calendarSelectedDay?.start),
                                'date',
                              )}',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: StreamBuilder<List<ClinicRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      ...
                                      options: dropDownClinicRecordList
                                          .map((e) => e.name)
                                          .toList(),
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      ...
                                      options: List<String>.from(
                                          dropDownDoctorRecordList
                                              ...
                                              .toList()),
                                      optionLabels: dropDownDoctorRecordList
                                          .map((e) => e.name)
                                          .toList(),
                                      onChanged: (val) => safeSetState(
                                ...
                                StreamBuilder<List<DoctorRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    final containerDoctorRecord =
                                        containerDoctorRecordList.isNotEmpty
                                            ? containerDoctorRecordList.first
                                            : null;
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if ((_model.calendarSelectedDay != null) &&
                        ...
                        _model.doctorRefFound = await queryDoctorRecordOnce(
                        ...
                        _model.doctorBooked = await queryEncounterRecordOnce(
                          queryBuilder: (encounterRecord) => encounterRecord
                              .where(
                                'doctor_id',
                                isEqualTo: _model.doctorRefFound?.reference,
                              )
                              .where(
                                'date',
                        ...
                        _model.motherBooked = await queryEncounterRecordOnce(
                          queryBuilder: (encounterRecord) => encounterRecord
                              .where(
                                'mother_id',
                        ...
                        if ((_model.doctorBooked != null) ||
                          ...
                          await EncounterRecord.collection
                              ...
                              .set(createEncounterRecordData(
                                doctorId: _model.doctorRefFound?.reference,
                                status: 'scheduled',
                                motherId: FFAppState().motherRef,
