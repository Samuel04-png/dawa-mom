...
class ForgotPasswordWidget extends StatefulWidget {
  const ForgotPasswordWidget({
    super.key,
    int? incrementer,
  }) : this.incrementer = incrementer ?? 0;
...
class _ForgotPasswordWidgetState extends State<ForgotPasswordWidget> {
  ...
  void initState() {
    ...
    _model.supportEmailTextController ??=
        TextEditingController(text: 'developer@thestackone.com');
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        validator: _model.userEmailTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ],
                    ...
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: _isSendingResetLink
                            ...
                            : () async {
                                final email =
                                    _model.userEmailTextController.text.trim();
                                if (email.isEmpty) {
                        ...
                        text: _isSendingResetLink ? 'Sending...' : 'Send link',
