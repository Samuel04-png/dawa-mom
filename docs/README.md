...
Dawa Mom is a Flutter maternal health companion app in the wider Dawa health ecosystem. I worked on this app around mother and pregnancy workflows: onboarding, profile completion, appointment views, pregnancy-week guidance, period tracking, clinical encounter results, and Rudo chat.
